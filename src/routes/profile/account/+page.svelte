  ...
  <div>
   ...
   {#if isHowItWorksOpened}
    <div class="prose my-4">
      ...
      <p>При открытии нового контракта по вашей реферальной ссылке вы получаете право на следующие процентные выплаты:</p>
      <ul>
        <li>1. Первая линия: 5% от суммы первоначального вложения, сделанного новым партнёром, зарегистрировавшимся по вашей реферальной ссылке.</li>
        <li>2. Вторая линия: 3% от суммы первоначального вложения, сделанного новым партнёром, привлечённым вашими рефералами первой линии.</li>
        <li>3. Третья линия: 2% от суммы первоначального вложения, сделанного новым партнёром, привлечённым вашими рефералами второй линии.</li>
      </ul>
      <h3>Индивидуальные Условия:</h3>
      <p>
        В случае высокой активности и успешных реферальных усилий, мы оставляем за собой право предложить вам индивидуальные условия и бонусы. Это наш способ признать ваш вклад в развитие нашего фонда и соответствующе вас вознаградить.
      </p>
    </div>
   {/if}
  </div>
