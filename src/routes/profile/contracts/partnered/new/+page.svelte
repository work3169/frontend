<script lang="ts">
    ...
    import NewPartneredContractsTable from "components/Profile/NewPartneredContractsTable.svelte";
</script>

<HeaderContainer>
    <h1 class="font-medium text-2xl bg-#295858">Создать партнерский контракт</h1>
